...
/*Ejercicio 1
Mostrar el nombre y apellido de todos los empleados junto con el numero de ordenes que han procesado*/
...
/*Ejercicio 2
Mostrar el nombre de cada categor�a y la cantidad de productos que pertenecen a esa categoria*/
...
/*Ejercicio 3
Mostrar el nombre de cada proveedor y el precio m�s alto y m�s bajo de los productos que proveen*/

...
/*---------------------------------------------------------
Ejercicio 1. Tabla temporal para almacenar resultados intermedios
o Calcular las ventas totales por producto del último mes y almacenar
temporalmente para análisis posterior.
---------------------------------------------------------*/
...
/*---------------------------------------------------------
Ejercicio 2. Tabla temporal para mejorar rendimiento en consultas repetitivas
o Crear una tabla temporal con los clientes más activos del último año para múltiples
consultas.
---------------------------------------------------------*/
...
/*---------------------------------------------------------
Ejercicio 3. Tabla temporal en un procedimiento almacenado
o Crear Proceso almacenado para calcular comisiones de vendedores usando una
tabla temporal.
---------------------------------------------------------*/
